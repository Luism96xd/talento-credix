...
const Index = () => {
  ...
  const handleSearch = async (position: string, location: string) => {
    ...
    if (!user) {
      toast({
        title: "Error",
        description: "Debes iniciar sesión para realizar búsquedas.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      // Save search to database with user_id
      ...
      const webhookPayload = {
        ...
        keywords: keywords,
        job_description_url: jobDescriptionFile,
        job_requisition_url: jobRequisitionFile,
        referenceCompanies: referenceCompanies,
        competenceCompanies: competenceCompanies,
      };
